/**
 * Chart.js 4.4.7 (UMD, minificado) -- vendorizado a mano el 2026-09-13,
 * ver docs/decisiones/0022-indicadores-chartjs.md. Nunca por CDN a
 * propósito (el proyecto no carga dependencias de terceros en runtime):
 * este archivo se sirve como estático propio, igual que las fuentes.
 * Actualizar a mano si hace falta una versión nueva -- no hay paso de
 * build que lo traiga solo.
 *
 * Original: https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js
